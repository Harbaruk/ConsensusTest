...
namespace ConsensusTester.DataAccess.Infrastructure
{
    ...
    {
        public ConsensusContext(DbContextOptions<ConsensusContext> options) : base(options)
        {
        }
            ...
            var entityConfigTypes = Assembly.GetExecutingAssembly()
                ...
                .Where(type => type.GetInterfaces()
                                        .FirstOrDefault(y => y.IsGenericType
                                                        && y.GetGenericTypeDefinition().UnderlyingSystemType == typeof(IEntityTypeConfiguration<>)) != null);
